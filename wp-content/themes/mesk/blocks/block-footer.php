	<footer id="footer">
		<div class="container-fluid">
			<div class="row">			
				<div class="col-lg-2 col-ml-3 col-md-6 col-sm-6 col-12 col">
				...
				<div class="col-lg-3 col-ml-3 col-md-5 col-sm-4 col-12 col main">
				...
				<div class="col-lg-4 col-ml-3 col-md-5 col-sm-8 col-12 col">
				...
				<div class="col-lg-3 col-ml-3 col-md-6  col-sm-6 col-12 col" itemscope itemtype="http://schema.org/Organization">
					<div class="footer-head">
						Контакты
					</div>
					<ul class="footer-contacts">
						<li itemprop="name"><?php echo get_field('company', 'option')['brand']; ?></li>
						<li itemprop="telephone"><?php echo do_shortcode('[phone]') ?> <a data-src="#popup-call" class="link" data-fancybox="">Заказать звонок</a> <span style="color:var(--color)"> (Звонок по РФ бесплатный) </span>	</li>
 ...
 <nobr><?php echo date('Y'); ?>г.</nobr><span class="sepa">/</span>
