...
//	Акции
//	====================
add_action( 'init', 'post_type_actions_goodini' );
 
function post_type_actions_goodini() {
	$labels = array(
		'name' => 'Акции',
		'all_items' => 'Все акции',
	...
	if (in_array("actions", get_field('sections','option'))) {
		register_post_type('actions', $args);
	}
}
add_filter( 'enter_title_here', 'actions_enter_title_here', 10, 2 );
function actions_enter_title_here( $text, $post ) {
